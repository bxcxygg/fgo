...
func NewAccountHandler(srv AccountHandler, opts ...http1.HandleOption) http.Handler {
	...
	r.HandleFunc("/api.account.v1.Account/CreateAccount", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.account.v1.Account/UpdateAccount", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.account.v1.Account/DeleteAccount", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.account.v1.Account/GetAccount", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.account.v1.Account/ListAccount", func(w http.ResponseWriter, r *http.Request) {
